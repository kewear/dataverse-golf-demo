...
def get_credential():
    ...
    if client_id and client_secret:
        ...
        # refresh, avoiding a browser prompt on every new process.
...
def get_token(scope=None):
    ...
    try:
        ...
        if isinstance(credential, InteractiveBrowserCredential) and not _auth_record_saved and not _AUTH_RECORD_PATH.exists():
